...
import { createBooking, getPousadaInfo } from '../services/api';
...
const CreateBookingModal: React.FC<CreateBookingModalProps> = ({ userId, onClose, onBookingSuccess, bookedDates }) => {
  const { token } = useAuth();
